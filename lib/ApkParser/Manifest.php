...
class Manifest extends \ApkParser\Xml {
	...
	*/
	public static $permissions =     array(
		...
		'WRITE_CONTACTS'  =>   'Allows an application to write (butnot read) the user\'s contacts data.',
		...
		'WRITE_SETTINGS'  =>   'Allows an application to reador write the system settings.',
